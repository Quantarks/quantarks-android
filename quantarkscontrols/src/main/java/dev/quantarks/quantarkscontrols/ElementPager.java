package dev.quantarks.quantarkscontrols;
 ...
 */
public class ElementPager extends ConstraintLayout {
    ...
    public ElementPager(Context context) {
        this(context, null);
    }

    public ElementPager(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        View view = layoutInflater.inflate(R.layout.sample_element_pager, this);
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.ElementPager, 0, 0);
        try {
            strTextTop = array.getString(R.styleable.ElementPager_textTop);
            strTextMiddle = array.getString(R.styleable.ElementPager_textMiddle);
            strTextBottom= array.getString(R.styleable.ElementPager_textBottom);
            pagerType = array.getInt(R.styleable.ElementPager_pagerType, 0);
            textColor = array.getColor(R.styleable.ElementPager_textColor, 0xFF333333);
        } finally {
            array.recycle();
        }
